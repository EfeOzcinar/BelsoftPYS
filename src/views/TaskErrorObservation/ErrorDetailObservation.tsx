...
import { Dimensions, ScrollView, StyleSheet, Text, TouchableOpacity, View, Image, FlatList } from 'react-native';
import LinearGradient from 'react-native-linear-gradient';
import Svg, { Circle } from 'react-native-svg';
import { ImpTable } from '../../components/BasicComponents';
...
function ErrorDetailObservation() {
    ...
    useEffect(() => {
        async function pageLoad() {
            ...
            if (data) {
                ...
                const favouriteList_ = await blsCore.services.errorService.getFavoriteInfoByErrorOid({ UserOid: userInfo.userOid, ErrorOid: data.Oid });
...
export default ErrorDetailObservation;
