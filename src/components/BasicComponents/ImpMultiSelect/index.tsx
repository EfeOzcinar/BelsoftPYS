...
export const useImpMultiSelect = (inputData: SelectDataProps) => {
...
function ImpMultiSelect({
  selectState,
  onChange,
  searchStyle,
  width = PageDimensions.wp * 0.47,
  ...
  return (
    <View>
      <Picker
          ...
          placeholder={selectState.label + ' Seçiniz...'}
          floatingPlaceholderStyle={{ 
            color: lightMode ? '#1A1C1C' : themeColor.pasifDayCard,
          ...
          renderCustomDialogHeader={({onDone, onCancel}) => (
            <View padding-s5 row spread style={{height:'15%',marginBottom:'-9%'}}>
