...
import { convertIntToDate, convertToDate, getResponsiveSize } from '../../../utilMethods';
...
interface UserTaskListModalProps {
    closePopup: any;
    userTaskListModal: any;
    priorityInfo: any;
    statusInfo: any;
    personnelInfo: any;
    companyInfo: any;
...
function UserTaskListModal({ closePopup, userTaskListModal, priorityInfo, statusInfo, personnelInfo, companyInfo }: UserTaskListModalProps) {
    const [userTaskListDataModal, setUserTaskListDataModal] = useState<any>([]);
    ...
    useEffect(() => {
        console.log("userTaskListModal", userTaskListModal);
        setUserTaskListDataModal(userTaskListModal);
    }, [userTaskListModal]);
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.tableContainer}>
                        <ImpTable
                            ...
                            rowsData={userTaskListDataModal}
                            tableHeader="İş Sıralaması"
                            tableContainerHeight={getResponsiveSize(500)}
                            tableHeight={getResponsiveSize(285)}
                        />
                    </View>
...
export default UserTaskListModal;